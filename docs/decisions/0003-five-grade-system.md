...
|---|---|---|---|---|
| **F** | 회피 권고. 사고 가능성 매우 높음 | `critical` | 🚫 빨강 | 즉각 재검토. 날짜 조정 또는 컨셉 전면 폐기 |
| **D** | 재검토 권고 | `danger` | ⚠️ 주황 | 컨셉 또는 카피 재작성. 위험 사유 명시 |
| **C** | 일반 주의. 톤·문구 조정 권장 | `caution` | ⚠️ 보라 | 인지하고 진행 가능. 핵심 단어 1~2개 교체 |
| **B** | 우려 낮음. 표준 주의 하에 진행 가능 | `safe` | ✅ 녹색 | 평상시 검토 통과 |
| **A** | 긍정 연관 (권장 톤 매칭) | `safe` | ✨ 파랑 | 적극 활용 가능 (예: 광복절·한글날 등 기념일 매칭) |
