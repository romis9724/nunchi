  ...
  return (
    <main style={{ minHeight: "100vh", background: "var(--rice-paper, #F8F7F4)" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "48px 24px 80px" }}>
        ...
        <p style={{ color: "var(--muted-ink)", fontSize: "13px", marginBottom: "40px" }}>최종 업데이트: 2026년 9월 13일</p>

        {[
          { title: "1. 서비스 목적", content: "nunch-i(눈치)는 마케팅 캠페인의 날짜별 사회·역사적 리스크를 사전 검토하는 참고용 서비스입니다. 본 서비스의 결과는 등록 데이터와 규칙·AI 분석에 기반하며, 최종 캠페인 결정은 이용자의 판단과 책임 하에 이루어집니다." },
          ...
          { title: "4. 면책 조항", content: "nunch-i의 검토 결과는 등록 데이터와 규칙·AI 분석에 기반한 참고 정보로만 제공됩니다. 결과의 정확성을 보장하지 않으며, 해당 결과를 바탕으로 실행된 캠페인에 대해 nunch-i는 법적 책임을 지지 않습니다. 최종 캠페인 집행 전 필요에 따라 관련 담당자나 전문가의 검토를 병행하는 것을 권장합니다." },
