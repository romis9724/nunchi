...
export default function LandingPage() {
  return (
    ...
    >
      ...
      {/* ── HERO ─────────────────────────────────────────────── */}
      <section
        style={{ maxWidth: "1160px", margin: "0 auto", padding: "72px 24px 56px" }}
        ...
        >
          ...
          <div>
            ...
            >
              캠페인 날짜,
              <br />
              <span style={{ color: "var(--ms-blue)" }}>안전하게</span>
              <br />
              출시하세요
            </h1>
            ...
            >
              <Link
                ...
                onMouseEnter={(e) => {
                  ...
                  el.style.background = "var(--ms-blue-dark)";
                  el.style.boxShadow = "0 4px 14px rgba(0,120,212,0.40)";
                }}
                onMouseLeave={(e) => {
                  const el = e.currentTarget as HTMLAnchorElement;
                  el.style.background = "var(--ms-blue)";
                  el.style.boxShadow = "0 2px 8px rgba(0,120,212,0.30)";
                }}
              >
                지금 무료로 시작하기 →
              </Link>
              <span style={{ fontSize: "12px", color: "var(--ms-text-3)" }}>
                회원가입 불필요 · 즉시 이용 가능
              </span>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                <p
                  style={{ fontSize: "12px", color: "var(--ms-text)", lineHeight: 1.55, margin: 0 }}
                >
                  사회운동 시기 광고 캠페인 → 전 세계 조롱·즉시 철회
                </p>
              </div>
              <div
                style={{
            ...
            >
              <div>
                ...
                <p style={{ fontSize: "13px", color: "var(--ms-text)", margin: 0 }}>
                  독립 테마 캠페인 최적 타이밍
                </p>
              </div>
              <GMini g="A" />
      ...
      {/* ── HOW IT WORKS ──────────────────────────────────────── */}
      <section
        style={{ padding: "80px 24px", maxWidth: "1160px", margin: "0 auto" }}
            ...
            {[
              {
                n: "01",
                title: "날짜 + 카피 입력",
                body: "캠페인 날짜, 카피, 비주얼 키워드를 입력합니다. 회원가입 불필요, 즉시 시작.",
              },
              {
                n: "02",
                title: "AI 교차 검토",
                body: "한국 민감일 31건+ 및 긍정 기념일 DB와 실시간 교차 분석. Gemini가 맥락을 읽습니다.",
              },
              {
                n: "03",
                title: "F–A 등급 확인",
                body: "회피(F)부터 최적 타이밍(A)까지 5단계 등급 + 구체적 사유 + 대안 카피.",
              },
            ].map((step, i) => (
              <div
                key={step.n}
                style={{
                  ...
                  gap: "24px",
                  padding: "28px 0",
                  borderBottom: i < 2 ? "1px solid var(--ms-surface-3)" : "none",
                }}
              >
                <span
                  style={{
          ...
          >
            {[
              ...
              >
                ...
                <p
                  style={{ fontSize: "10px", color: item.tc, fontWeight: 700, margin: 0 }}
                >
                  예: {item.ex}
                </p>
              </div>
      ...
      {/* ── DEMO LINKS ────────────────────────────────────────── */}
      <section
        style={{ maxWidth: "1160px", margin: "0 auto", padding: "64px 24px" }}
        className="section-pad"
      >
        <p
          style={{
        ...
        >
          {[
            ...
            >
              ...
              <p
                style={{ fontSize: "12px", color: item.tc, fontWeight: 700, margin: 0 }}
              >
                {item.sub} →
              </p>
            </Link>
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: "12px", color: "var(--ms-text-3)", margin: 0 }}>
            이 서비스의 결과는 참고용입니다. © 2026 Nunchi.
          </p>
          <div style={{ display: "flex", gap: "16px" }}>
            <Link
              href="/calendar"
              style={{ fontSize: "12px", color: "var(--ms-text-2)", textDecoration: "none" }}
            >
              리스크 캘린더
            </Link>
            <Link
