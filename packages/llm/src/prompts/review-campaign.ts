 ...
 * "3" = 등급 라벨 권고형 전환 (회피 권고 / 우려 낮음 / 긍정 연관).
 */
...
| 등급 | 의미 | 기준 |
|---|---|---|
| F | 회피 권고 | 역사적 비극(학살·재난·의거)과 직접 충돌. 브랜드 사고 위험 높음. |
| D | 재검토 권고 | 연상 가능한 민감 요소 존재. 컨셉·카피 재검토 강력 권고. |
| C | 일반 주의 | 특별한 위험·호재 없음. 표준 마케팅 주의 수준. |
| B | 우려 낮음 | 긍정적 연관이 있거나 민감 요소 없음. 안심하고 진행 가능. |
| A | 긍정 연관 | 국가 기념일·상업 이벤트·문화 특의일과 강한 긍정 연관. 캠페인 부스트 기회. |
